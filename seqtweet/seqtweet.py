...
class SeqTweet(object):
    ...
    @staticmethod
    def _chunk_data(front_pad_size, data, sep=' ', max_size=280):
    ...
    @staticmethod
    def _list_to_twitter(api, l, max_size=280):
    ...
    def create(self, data, sep=' ', max_size=280):
    ...
    def update(self, tweet_id, data, sep=' ', max_size=280):
        try:
